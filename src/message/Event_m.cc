//
// Generated file, do not edit! Created by nedtool 5.4 from message/Event.msg.
//
...
Event::Event(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    this->marker = false;
    this->time = 0;
    this->vehicleID = 0;
...
Event::Event(const Event& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
bool Event::getMarker() const
{
    return this->marker;
}

void Event::setMarker(bool marker)
{
    this->marker = marker;
}
...
void Event::setVehicleID(int vehicleID)
{
    this->vehicleID = vehicleID;
}

double Event::getSpeed() const
{
    return this->speed;
}

void Event::setSpeed(double speed)
{
    this->speed = speed;
}

const char * Event::getLaneID() const
{
    return this->laneID.c_str();
}

void Event::setLaneID(const char * laneID)
{
    this->laneID = laneID;
}
...
EventDescriptor::EventDescriptor() : omnetpp::cClassDescriptor("Event", "omnetpp::cMessage")
{
...
int EventDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='l' && strcmp(fieldName, "laneID")==0) return base+4;
...
std::string EventDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getTime());
        case 2: return long2string(pp->getVehicleID());
        case 3: return double2string(pp->getSpeed());
        case 4: return oppstring2string(pp->getLaneID());
        default: return "";
    }
}
...
bool EventDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setTime(string2long(value)); return true;
        case 2: pp->setVehicleID(string2long(value)); return true;
        case 3: pp->setSpeed(string2double(value)); return true;
        case 4: pp->setLaneID((value)); return true;
